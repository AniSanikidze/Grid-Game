    ...
    def play(self,num_games):
        ...
        for ep_num in range(num_games):
            ...
            self.get_random_training_info(
                ep_num, ep_rewards, number_of_iterations, trajectory, starting_position, info)
            episode_rewards.append(ep_rewards)
            Training.get_training_results(Training,ep_num,ep_results,episode_rewards,num_of_iterations)
